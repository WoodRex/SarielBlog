  ...
  return (
    <aside className="ml-4 hidden w-1/4 h-80s rounded-b bg-white p-8 shadow sm:block">
      ...
      <div className="text-left">
        ...
        <span className="mt-4 inline-grid grid-cols-3 gap-2">
            <span>
              {/* Twitter */}
            ...
            <span>
              ...
              <button class="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" class="w-4" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
